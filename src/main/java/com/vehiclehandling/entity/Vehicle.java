...
public abstract class Vehicle {
    ...
    // This turns the vehicle into a text line (like "1,Toyota,Corolla,AB123,15/05/2025,Black,2000,Manual")
    // We use this to save the vehicle to a file
    @Override
    public String toString() {
        return id + "," + make + "," + model + "," + registrationNumber + "," +
                maintenanceSchedule + "," + color + "," + year + "," + transmissionType;
    }
    // This takes a text line from the file (like "1,Toyota,Corolla,AB123,15/05/2025,Black,2000,Manual")
    // and turns it back into a vehicle. It decides if it’s a Manual or Automatic vehicle
